...
def _draw_aqi_hero(
    ...
    split = int(W * 0.40)   # left column width
    pad = 20
...
def _draw_scale_bar(
    ...
    label_font = style.font_regular(9)
    prev_bound = 0
...
def _draw_pm_row(
    ...
    unit_font = style.font_regular(10)
...
def _draw_ambient_cards(
    ...
    icon_font = weather_icon_font(20)
    val_font = style.font_bold(15)
...
def _draw_current_conditions(
    ...
    desc_font = style.font_regular(12)
