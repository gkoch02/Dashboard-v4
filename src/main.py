...
def main():
    ...
    parser.add_argument(
        "--theme",
        choices=["default", "diags", "fantasy", "fuzzyclock", "minimalist", "old_fashioned",
                 "qotd", "random", "terminal", "today", "weather"],
        default=None,
        metavar="THEME",
        help=(
            "Override the theme from config. "
            "Choices: default, diags, fantasy, fuzzyclock, minimalist, old_fashioned, qotd, "
