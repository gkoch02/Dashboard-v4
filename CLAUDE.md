...
make version        # Print current version (e.g. main.py 4.2.1)
...
├── _version.py                # Single source of truth: __version__ = "4.2.1"
...
--version              Print version and exit (e.g. "main.py 4.2.1")
```
